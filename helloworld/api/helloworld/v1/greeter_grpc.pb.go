...
const (
	...
	Greeter_Register_FullMethodName = "/helloworld.v1.Greeter/Register"
)
...
func (c *greeterClient) Register(ctx context.Context, in *RegisterRequest, opts ...grpc.CallOption) (*RegisterReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedGreeterServer) Register(context.Context, *RegisterRequest) (*RegisterReply, error) {
